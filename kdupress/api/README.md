...
Component based localization option.
  ...
  * **See also:** `KduI18n` class constructor options
...
`KduI18n` class implement `I18n` interface of [flowtype definitions](https://github.com/khanhduy1407/kdu-i18n/blob/master/decls/i18n.js)
...
You can specify the below some options of `I18nOptions` constructor options of [flowtype definitions](https://github.com/khanhduy1407/kdu-i18n/blob/master/decls/i18n.js)
...
The datetime formats of localization.
  ...
  * **See also:** `DateTimeFormats` type of [flowtype definitions](https://github.com/khanhduy1407/kdu-i18n/blob/master/decls/i18n.js)
...
The number formats of localization.
  ...
  * **See also:** `NumberFormats` type of [flowtype definitions](https://github.com/khanhduy1407/kdu-i18n/blob/master/decls/i18n.js)
...
This is the same as `$d` method of Kdu instance method. More detail see [$d](#d).
...
This is the same as `$n` method of Kdu instance method. More detail see [$n](#n).
...
:::tip NOTE
The element `textContent` will be cleared by default when `k-t` directive is unbinded. This might be undesirable situation when used inside [transitions](https://kdujs-v2.web.app/v2/guide/transitions.html). To preserve `textContent` data after directive unbind use `.preserve` modifier or global [`preserveDirectiveContent` option](#preservedirectivecontent).
:::
  * **Examples:**
```html
