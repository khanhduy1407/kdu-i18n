...
KduI18n.prototype.unsubscribeDataChanging = function unsubscribeDataChanging (vm) {
  remove(this._dataListeners, vm);
};

KduI18n.prototype.watchI18nData = function watchI18nData () {
  var self = this;
...
KduI18n.prototype.watchLocale = function watchLocale () {
  /* istanbul ignore if */
...
KduI18n.prototype.t = function t (key) {
    var ref;
...
KduI18n.prototype._i = function _i (key, locale, messages, host, values) {
  var ret =
...
KduI18n.prototype.i = function i (key, locale, values) {
  /* istanbul ignore if */
  if (!key) { return '' }
...
KduI18n.prototype._tc = function _tc (
  key,
  _locale,
  messages,
  host,
...
KduI18n.prototype._te = function _te (key, locale, messages) {
...
KduI18n.prototype.te = function te (key, locale) {
  return this._te(key, this.locale, this._getMessages(), locale)
};

KduI18n.prototype.getLocaleMessage = function getLocaleMessage (locale) {
...
KduI18n.prototype._d = function _d (value, locale, key) {
  /* istanbul ignore if */
  if (process.env.NODE_ENV !== 'production' && !KduI18n.availabilities.dateTimeFormat) {
...
KduI18n.prototype.d = function d (value) {
    var args = [], len = arguments.length - 1;
    while ( len-- > 0 ) args[ len ] = arguments[ len + 1 ];
...
KduI18n.prototype.getNumberFormat = function getNumberFormat (locale) {
...
KduI18n.prototype.n = function n (value) {
    var args = [], len = arguments.length - 1;
    while ( len-- > 0 ) args[ len ] = arguments[ len + 1 ];
