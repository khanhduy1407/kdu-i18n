...
import { isNumber, isString, isObject } from '@kdu-i18n/shared'
import { TransrateKNodeSymbol } from '../composer'
import { useI18n } from '../i18n'
import { baseFormatProps } from './base'
import { assign } from '@kdu-i18n/shared'

import type { SetupContext, KNodeChild, RenderFunction } from 'kdu'
import type { Composer, ComposerInternal } from '../composer'
import type { TranslateOptions } from '@kdu-i18n/core-base'
 ...
 *
 * @KduI18nSee [TranslationProps](component#translationprops)
 * @KduI18nSee [BaseFormatProps](component#baseformatprops)
 * @KduI18nSee [Component Interpolation](../guide/advanced/component)
 *
 * @example
 * ```html
 * <div id="app">
...
export const Translation = {
  ...
  setup(props: TranslationProps, context: SetupContext): RenderFunction {
    ...
    return (): KNodeChild => {
      ...
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      const children = (i18n as any)[TransrateKNodeSymbol](
        props.keypath,
        arg,
        options
      )
